...
public class cflipkart_1Half {
	 ...
	 public static void main(String[] args) throws Exception{
	        ...
	        try {
	            ...
	            Sheet urlsSheet = urlsWorkbook.getSheet("Flk_Mum");//560001--Beng  //400070-lucknow  //400070 -mum
...
//	                        NewAvailability1 = String.valueOf(result);
	              ...
	              try {
	                  ...
	                  String outputFilePath = ".\\Output\\Flipkart_Flk_Flk_Mum_output" + timestamp + ".xlsx";
