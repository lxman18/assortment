                ...
                try {
                    ...
                    if (currentPin == null || !currentPin.equals(locationSet)) {
                    	...
                    	Thread.sleep(3000);
     					...
     					location.click();
     					Thread.sleep(2000);     
     					WebElement loctionsetq = driver.findElement(By.xpath("/html/body/div[1]/header/div/div/div/div[1]/div[2]/div/div"));
     					loctionsetq.click();
//     					Thread.sleep(2000);
...
//      					locationset.click();
                    		...
                    		Thread.sleep(3000);
                       	 WebElement location = driver.findElement(By.xpath("//div[@class='NewSearchLocationSuggestor_searchBlock__UPPqn']//div[@class='bL']//input"));
        					location.click();
                    	}
     				//	Thread.sleep(1000);
     					...
     					for (int j = 0; j < 200; j++) {
     						try {
     							driver.findElement(
     									By.xpath("//div[@class='NewSearchLocationSuggestor_searchBlock__UPPqn']//div[@class='bL']//input"))
     									.sendKeys(Keys.ENTER);
     							
     							Thread.sleep(3000);
     							
     							driver.findElement(
     									By.xpath("//div[@class='NewSearchLocationSuggestor_searchBlock__UPPqn']//div[@class='bL']//input")).clear();
      							Thread.sleep(3000);
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("//span[@class='UN_ ']"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("//p[contains(@class,'bD VB')]//span[@class='UN_ ']"));
...
//                    		}
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//div[contains(@class,'SN_')]//p[1]"));
           ...
           /*         if(mrpValue == spValue) {
                	 ...
                	 //*[@id="corePriceDisplay_desktop_feature_div"]/div[1]/span[2]/span[2]/span[2]
                	   try {
                	   WebElement sp = driver.findElement(By.xpath("//div[@class='F_']//p[contains(@class,'bD VB')][1]"));
                       ...
                       System.out.println(spValue);
                	     ...
                	     try {
                    		   WebElement sp = driver.findElement(By.xpath("//div[@class='E_']//div[@class='F_']//p[contains(@class,'bD VB')][1]"));
                               originalSp2 = sp.getText();
...
//	       			}
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Apollo_Pharama1_OutputData_" + timestamp + ".xlsx";
