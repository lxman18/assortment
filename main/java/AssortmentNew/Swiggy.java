...
public class Swiggy {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String filePath = ".\\input-data\\Swiggy-2Assortment.xlsx";
                	  ...
                	  try {
                          ...
                          try {
                              ...
                              System.out.println(mrpValue);
                           	   ...
                           	   try {
                                      WebElement mrp = driver.findElement(By.xpath("//div[@data-testid='item-price']"));
                                      originalMrp1 = mrp.getText();
                                      mrpValue = originalMrp1.replace("₹", "");
                                      System.out.println(mrpValue);
                          ...
                          try {
                       	   ...
                       	   WebElement webUom1 = driver.findElement(By.xpath("//div[@class='sc-aXZVg kYaBqd _1TwvP']"));
            ...
            try {
                ...
                String outputFilePath = ".\\Output\\Swiggy_6_OutputData" + timestamp + ".xlsx";
