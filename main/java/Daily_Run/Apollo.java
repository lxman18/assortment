                ...
                try {
                    ...
                    if (currentPin == null || !currentPin.equals(locationSet)) {
                    	...
                    	Thread.sleep(3000);
     					...
     					location.click();
     					Thread.sleep(2000);     
     					WebElement loctionsetq = driver.findElement(By.xpath("/html/body/div[8]/div[2]/div/div[2]/button[2]"));
     					loctionsetq.click();
//     					Thread.sleep(2000);
...
//      					locationset.click();
                    ...
                    try {
                    WebElement mrp = driver.findElement(By.xpath("//div[@class='PdpWeb_addToCartSection__RGnBF']//div[@class='El_  dh  ']//p[2]"));
                    ...
                    System.out.println(mrpValue);
                    	...
                    	try {
                    		...
                    		WebElement mrp = driver.findElement(By.xpath("//div[@class='PdpWeb_addToCartSection__RGnBF']//div[@class='El_  dh  th']//p[2]"));
...
//                    		}
                   ...
                   try {
                    WebElement sp = driver.findElement(By.xpath("//div[@class='PdpWeb_addToCartSection__RGnBF']//div[@class='El_  dh  ']//p[1]"));
           ...
           /*         if(mrpValue == spValue) {
                	 ...
                	 //*[@id="corePriceDisplay_desktop_feature_div"]/div[1]/span[2]/span[2]/span[2]
                	   try {
                	   WebElement sp = driver.findElement(By.xpath("//div[@class='PdpWeb_addToCartSection__RGnBF']//div[@class='El_  dh  th']//p[1]"));
